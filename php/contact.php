...
$to    = "test@gmail.com"; // <--- Your email ID here

$server_email = 'webmaster@godaddy.com';  // Your server email to authenticate outgoing emails. eg: name@yourdomain.com
/*
 * ------------------------------------
 * END CONFIGURATION
 * ------------------------------------
...
if (isset($quantity) && isset($quantity_days)) {

	$subject  = ""; // <--- Contact for Subject here.
 
	$msg      = 'Hello Admin, <br/> <br/> Here are the order details:';
